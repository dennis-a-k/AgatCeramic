...
@section('content')
    <form method="POST" action="{{ route('zatirka.update', $product->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')

        <div class="row">
            <section class="col-md-6">
                @include('components.admin.goods.zatirka.edit-zatirka-information')
            </section>

            <section class="col-md-6">
                @include('components.admin.goods.zatirka.edit-zatirka-select')
                @include('components.admin.goods.zatirka.edit-zatirka-images')
            </section>
