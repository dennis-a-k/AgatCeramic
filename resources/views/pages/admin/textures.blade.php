...
@section('content-header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-info">Поверхность</h1>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-xs">
                                                ...
                                                <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalDelete" data-texture="{{ $texture }}" data-content="Удалить">
