                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                ---
                                @else
                                <img src="{{ URL::asset('storage/brands/' . $brand->img) }}" alt="{{ $brand->title }}"
                                    height="35px">
                                @endif
                            ...
                            <td class="align-middle">
                                <div class="btn-group btn-group-xs">
                                    ...
                                    <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalDelete"
                                        data-brand="{{ $brand }}" data-content="Удалить">
