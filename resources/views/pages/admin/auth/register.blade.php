        ...
        <div class="register-box mt-5">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    <form action="{{ route('register.store') }}" method="POST" class="my-4" id="quickForm">
                        @csrf
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input custom-control-input-info" type="radio" id="customRadio1" name="role" value="admin">
                                        <label for="customRadio1" class="custom-control-label">Администратор</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input custom-control-input-info" type="radio" id="customRadio2" name="role" value="user" checked>
