<table>
    <thead>
        <tr height="50">
            ...
            <th width="20" style="border:1px solid #8EAADB; background-color:#B4C6E7">Размер (см)</th>
            ...
            <th width="20" style="border:1px solid #8EAADB; background-color:#B4C6E7">Габариты (см)</th>
