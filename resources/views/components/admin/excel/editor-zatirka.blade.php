<table>
    <thead>
        <tr height="50">
            ...
            <th width="20" style="border:1px solid #8EAADB; background-color:#B4C6E7">Вес (кг)</th>
            <th width="20" style="border:1px solid #8EAADB; background-color:#B4C6E7">Использовать в качестве клея</th>
            <th width="20" style="border:1px solid #8EAADB; background-color:#B4C6E7">Ширина шва (мм)</th>
        </tr>
    </thead>
</table>
