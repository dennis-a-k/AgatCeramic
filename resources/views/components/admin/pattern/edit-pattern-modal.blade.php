<button class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalEdit" data-pattern="{{ $pattern }}" data-content="Редактировать">
...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelAdd" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('pattern.update') }}">
                @csrf
                @method('PATCH')
