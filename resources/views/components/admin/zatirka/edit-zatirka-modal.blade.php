<button class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalEdit" data-child="{{ $child }}" data-content="Редактировать">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabelAdd">
                    Редактирование типа затирки
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{ route('grout_type.update') }}">
                @csrf
                @method('PATCH')
