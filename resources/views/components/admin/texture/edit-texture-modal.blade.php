<button class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalEdit" data-texture="{{ $texture }}" data-content="Редактировать">
...
<div class="modal fade" id="modalEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelAdd" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('texture.update') }}">
                @csrf
                @method('PATCH')
                <div class="modal-body">
                    <div class="form-group">
                        <div>
                            ...
                            <input type="text" id="inputTexture" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }} modal-title" name="title" value="" required autofocus
                                autocomplete="title">
