...
class PageEditorKleya implements WithEvents, WithTitle, FromView
{
    ...
    {
        return view('components.admin.excel.editor-kleya');
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getDelegate()->getStyle('A2:I1002')->applyFromArray($styleBorders);
            }
        ];
    }
}
